...
import csv
def save_prompt_response_csv(list_a, list_b, list_c, list_d, filename, col1="prompt", col2="response", col3="label", col4="embedding_similairty"):
...
if DATASETS[0] == 1:
    ...
    save_prompt_response_csv(
        ...
        LABELS_STR,
        EMBEDDING_SIMILAIRITY,
        args.dir + "/mulit_generation_self_base_embedding_similarity_wildjailbreak.csv"
    )
...
if DATASETS[1] == 1:
    ...
    save_prompt_response_csv(
        ...
        LABELS_STR,
        EMBEDDING_SIMILAIRITY,
        args.dir + "/mulit_generation_self_base_embedding_similarity_strongreject.csv"
    )
...
if DATASETS[2] == 1:
    ...
    save_prompt_response_csv(
        ...
        LABELS_STR,
        EMBEDDING_SIMILAIRITY,
        args.dir + "/mulit_generation_self_base_embedding_similarity_DAN.csv"
    )
