...
parser.add_argument("--min_p", type=float, default=0.95)
parser.add_argument("--top_k", type=int, default=30)

parser.add_argument("--start", type=int, default=0)
parser.add_argument("--end", type=int, default=4096)
...
dts = load_dataset("UCSC-VLAA/STAR-41K")["train"].select(range(args.start, args.end))
...
dataset.push_to_hub("Pankayaraj/STAR-41K-DA-Unfiltered-" + args.model.split("/")[-1], token=args.hf_token)